...
Essa classe também deve definir os seguintes atributos: nome , matricula e
salario_base .
Essa classe abstrata deverá ser herdada pelas outras classes que são: Gerente,
Assistente e Vendedor .
Em cada classe filha deve-se sobrescrever o método calcular_salario(). Este
método deve calcular e retornar o salário de cada funcionário, da seguinte
forma:
...
Implemente um programa principal que cria um objeto de cada tipo (gerente,
assistente e vendedor)
